      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <header className="text-center py-16 animate-fade-in">
          <div className="mb-8 max-w-3xl mx-auto">
            <img 
              src="https://cdn.poehali.dev/projects/6cb7fb8f-9dd5-4c9d-960f-17fd3681d8bb/files/18f0cc59-77b2-4bfc-bf66-e3c811f6affc.jpg" 
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start gap-4 md:col-span-2">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-foreground">База отдыха "Рыбацкий рай"</p>
                    <p className="text-lg text-muted-foreground mt-1">Московская область, берег озера Лесное</p>
                  </div>
                </div>
              </div>
            </CardContent>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-foreground">+7 (999) 123-45-67 - мама Ромы</p>
                    </div>
                  </div>
                </div>
              </div>
